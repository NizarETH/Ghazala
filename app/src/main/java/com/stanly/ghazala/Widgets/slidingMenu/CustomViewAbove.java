package com.stanly.ghazala.Widgets.slidingMenu;
...
public class CustomViewAbove extends ViewGroup {
	 ...
	 * specified item.
	 *
	 * @param item MYITEM index to select
	 */
...
/*				mIsBeingDragged = false;
	...
	public boolean onTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_UP:
			if (mIsBeingDragged) {
				...
				// TODO list_menu this. should get better flinging behavior
	 ...
	 *
	 * @param v View to list_menu for horizontal scrollability
